...
const Sidenav = () => {
  return (
    <div  className="w-[20%] scrollbar-hide h-screen border-r-2
     overflow-y-scroll  border-zinc-400 p-10  ">
      <h1 className="text-2xl text-white font-bold">
        <i className="text-[#6556CD] ri-tv-fill mr-2"></i>
        <span className="text-2xl">ScreenPedia</span>
      </h1>
      ...
      <nav className="flex flex-col text-zinc-400 text-lg gap-3">
        ...
        <Link className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-2">
          <i className="mr-2 ri-information-fill"></i> About ScreenPedia
        </Link>
        <Link className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-2">
